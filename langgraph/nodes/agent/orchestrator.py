...
def orchestrator_node(state: Dict[str, Any]) -> None:
    ...
    if current_node == 'trigger_analysis':
        ...
        if detected_trigger is None:
            ...
            state['selected_action'] = {"status": "no_action_needed", "reason": "no_trigger_detected"}
            state['current_node'] = 'orchestrator'
            state['next_node'] = END
            return
        ...
        if trigger_id == 'neutral' or 'neutral' in trigger_id.lower():
            ...
            state['selected_action'] = {"status": "no_action_needed", "reason": "neutral_trigger"}
            state['current_node'] = 'orchestrator'
            state['next_node'] = END
            return
    ...
    if current_node == 'decision_maker':
        ...
        if selected_action is None:
            ...
            state['selected_action'] = {"status": "no_action_needed", "reason": "no_action_selected"}
            state['current_node'] = 'orchestrator'
            state['next_node'] = END
            return
    ...
    if current_node == 'validator':
        ...
        if approved:
            ...
            # Ensure selected_action has the final styled_response
